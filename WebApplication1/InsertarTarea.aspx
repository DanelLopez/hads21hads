...
<body>
    ...
    <div>
            ...
            <tr>
                <td class="auto-style2" colspan="2">
                    <p style="text-align: center; font-size: 40px; font-style: normal; font-variant: small-caps; color: #0000FF; background-color: #C0C0C0; font-weight: bold; width: 1697px;"> 
                        <br />
                        PROFESOR =&gt;  GESTION DE TAREAS GENÉRICAS
                        <br /><br />
                    </p>
                </td>
            </tr>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Server=tcp:hads21hads.database.windows.net,1433; Initial Catalog=1617hads21; Persist Security Info=False; User ID=hads21@hads21hads; Password=PerroPerro1" SelectCommand="SELECT Asignaturas.codigo FROM Asignaturas 
