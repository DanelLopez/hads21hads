...
Public Class InsertarTarea
    ...
    Dim conClsf As SqlConnection = New SqlConnection("Server=tcp:hads21hads.database.windows.net,1433; Initial Catalog=1617hads21; Persist Security Info=False; User ID=hads21@hads21hads; Password=PerroPerro1")
