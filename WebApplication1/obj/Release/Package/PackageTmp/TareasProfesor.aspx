...
<body>
    ...
    <table style="width:100%;">
            <tr>
                <td style="width:80%;">
                    <p style="text-align: center; font-size: 40px; font-style: normal; font-variant: small-caps; color: #0000FF; background-color: #C0C0C0; font-weight: bold;"> 
                     <br />
                    PROFESOR:
                                <asp:Label ID="LabelUser" runat="server"></asp:Label>=&gt; GESTION DE TAREAS GENÉRICAS <br /><br />
                     </p>
                </td>
                <td style="width:20%;">
                    &nbsp;</td>                
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="Server=tcp:hads21hads.database.windows.net,1433; Initial Catalog=1617hads21; Persist Security Info=False; User ID=hads21@hads21hads; Password=PerroPerro1" 
